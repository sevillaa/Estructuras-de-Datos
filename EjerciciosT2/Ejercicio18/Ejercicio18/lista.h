...
public:
	...
	*/
    ...
    void concatena(const Lista<T> &l2) {
    
        Nodo *aux_l1 = _prim;
        Nodo *aux_l2 = l2._prim;
        //1.Lista l2 vacia
        while(aux_l2 != nullptr){
            //2.Lista l2 no vacia
            if(_prim == nullptr){
                //l1 es vacia, inserto en l1 el primer valor de l2
                Nodo *nuevo = new Nodo(aux_l2->_elem);
                _prim = nuevo;
                _ult = nuevo;
                aux_l1 = _prim;
                aux_l2 = aux_l2->_sig;
                ...
                //Ahora inserto en una lista no vacia
                if(aux_l2->_elem <= aux_l1->_elem){
                    if(aux_l1 == _prim){
                        Nodo *nuevo = new Nodo(aux_l2->_elem);
                        aux_l1->_ant = nuevo;
                        nuevo->_sig = aux_l1;
                        ...
                        Nodo *nuevo = new Nodo(aux_l2->_elem);
                        nuevo->_ant = aux_l1->_ant;
                        nuevo->_sig = aux_l1;
                        aux_l1->_ant->_sig = nuevo;
                        aux_l1->_ant = nuevo;
                        _numElems++;
                    }
                    aux_l2 = aux_l2->_sig;
                }else{
                    if(aux_l1 == _ult){//Cuando
                        Nodo *nuevo = new Nodo(aux_l2->_elem);
                        nuevo->_ant = aux_l1;
                        aux_l1->_sig = nuevo;
                        _ult = nuevo;
